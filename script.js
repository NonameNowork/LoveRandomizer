...
const tasks = {
    ...
    girl:["Съесть картошку", "Потанцевать много", "Кукарекать 20 секунд", "Стоять на ногах", "Приготовить ужин", "Скорчить морду","Посмеяться","Помыть посуду","Сделать видео","Говорить минуту голосом"]
}
...
function chooseTaskCount(event) {
    const useChoice = event.target.value;
    toGameOver = parseInt(useChoice)*2;
}
